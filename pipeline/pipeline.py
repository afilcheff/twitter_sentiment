...
INPUT_SUBSCRIPTION = "projects/<projectID>/subscriptions/<subscriptionID>"
BIGQUERY_TABLE = "<projectID>:<dataset>.<table>"
BIGQUERY_SCHEMA = "id:NUMERIC,text:STRING,user_id:NUMERIC,posted_at:TIMESTAMP,sentiment:STRING"
...
class CustomParsing(beam.DoFn):
    ...
    def process(self, element: bytes, window=beam.DoFn.WindowParam):#, timestamp=beam.DoFn.TimestampParam
        """
